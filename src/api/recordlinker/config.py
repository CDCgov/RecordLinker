...
class Settings(pydantic_settings.BaseSettings):
    ...
    db_uri: str = pydantic.Field(
        description="The URI for the MPI database",
    )
    secret_key: str = pydantic.Field(
        description="The secret key for the application to sign and encrypt data",
    )
    ...
    ui_static_dir: str = pydantic.Field(
        description="The path to the static files generated by the UI",
        default="",
    )
    session_cookie_domain: typing.Optional[str] = pydantic.Field(
        description="The domain for the session cookie",
        default=None,
    )
    session_cookie_secure: bool = pydantic.Field(
