...
def run_pyway(
    ...
    try:
        pyway_response = subprocess.run(full_command, shell=True, check=True, capture_output=True)
        ...
        if "ERROR: no migrations applied yet, no validation necessary." in error_message:
