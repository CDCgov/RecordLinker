...
class TestNormalizePhoneNumber:
    def test_normalize_phone_number(self):
        phone = "223-456-7890"
        assert utils.normalize_phone_number(phone) == "+12234567890"
        ...
        assert utils.normalize_phone_number(phone) == "+442234567890"

        # Test example showing the limit of the normalization
        phone = "44 223-456-7890 456"
        assert utils.normalize_phone_number(phone) == "+1442234567890456"
