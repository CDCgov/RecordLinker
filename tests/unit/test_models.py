...
class TestBlockingKey:
    def test_extract_birthdate(self):
        data = {"dob": "01/01/1980"}
        assert models.BlockingKey.BIRTHDATE.to_value(data) == []
    ...
    def test_extract_mrn_last_four(self):
        data = {"ssn": "123456789"}
        assert models.BlockingKey.MRN.to_value(data) == []
        data = {"mrn": "123456789"}
    ...
    def test_extract_sex(self):
        data = {"gender": "M"}
        assert models.BlockingKey.SEX.to_value(data) == []
        data = {"sex": "M"}
    ...
    def test_extract_zipcode(self):
        data = {"zip": "12345"}
        assert models.BlockingKey.ZIP.to_value(data) == []
    ...
    def test_extract_first_name_first_four(self):
        ...
        assert models.BlockingKey.FIRST_NAME.to_value(data) == []
    ...
    def test_extract_last_name_first_four(self):
        data = {"last_name": "Doe"}
        assert models.BlockingKey.LAST_NAME.to_value(data) == []
