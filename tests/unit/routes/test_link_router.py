...
class TestLink:
    ...
    def test_link_success(self, patched_subprocess, default_algorithm, patients, client):
        ...
        assert person_1
        assert response_1.json()["prediction"] == "certainly-not"
        ...
        assert response_2.json()["prediction"] == "certain"
        ...
        assert person_3
        assert response_3.json()["prediction"] == "certainly-not"
        ...
        assert response_4.json()["prediction"] == "certain"
        assert len(response_2.json()["results"]) == 1
        ...
        assert person_5
        assert response_5.json()["prediction"] == "certainly-not"
        assert not response_3.json()["results"]
        ...
        assert person_6
        assert response_6.json()["prediction"] == "certainly-not"
...
class TestLinkFHIR:
    ...
    def test_success(self, patched_subprocess, default_algorithm, client):
        ...
        assert resp_1.json()["prediction"] == "certainly-not"
        ...
        assert resp_2.json()["prediction"] == "certain"
        ...
        assert resp_3.json()["prediction"] == "certainly-not"
        ...
        assert resp_4.json()["prediction"] == "certain"
        ...
        assert resp_5.json()["prediction"] == "certainly-not"
        ...
        assert resp_6.json()["prediction"] == "certainly-not"
...
class TestMatch:
    ...
    def test_no_match(self, client, default_algorithm, patients):
        ...
        payload = resp.json()
        assert payload["prediction"] == "certainly-not"
    ...
    def test_match(self, client, default_algorithm, patients):
        ...
        assert resp.status_code == status.HTTP_200_OK
        payload = resp.json()
        assert payload["prediction"] == "certain"
